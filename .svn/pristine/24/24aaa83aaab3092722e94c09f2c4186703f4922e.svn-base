...
$(".Smohan_Layer_Shade").click(function(e){$('.Smohan_Layer_box').animate({opacity:'hide',marginTop:'-300px'},"slow",function(){$('.Smohan_Layer_Shade').hide();$('.Smohan_Layer_box .loading').show();});});};})(jQuery);
...
$(document).ready(function(e) {
	...
	share_html += '<li title="分享到QQ好友"><a href="javascript:void(0)" class="share0"></a><span></span></li>';
	share_html += '<li title="分享到微信"><a href="javascript:void(0)" class="share01"></a><span></span></li>';
...
var share_from = encodeURIComponent("兼职e族官方网站"); //分享自（仅用于QQ空间和朋友网，新浪的只需更改appkey 和 ralateUid就行）
//Qzone
$('#Share .share0').click(function(e) {
...
$('#Share .share1').click(function(e) {
    window.open("http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="+share_url+"&title="+share_title+"&pics="+share_pic+"&site="+share_from+"","newwindow");
});	  
//Sina Weibo
$('#Share .share2').click(function(e) {
var param = {
    url:share_url ,
    appkey:'678438995',
    title:share_title,
